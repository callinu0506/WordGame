...
public class GUI extends JFrame implements ActionListener
{
   ...
   JMenu attributionMenu = new JMenu("Attribution");
   ...
   JMenuItem soundMenu = new JMenuItem("Sound Attribution");
   JMenuItem imageMenu = new JMenuItem("Image Attribution");
   ...
   // Audio thread for when game starts
   ThreadAudio threadIntro = new ThreadAudio();
   Thread t1 = new Thread(threadIntro);
   
   // Add images for animation with timer that makes black arrow blink off and on
   ImageIcon blackArrow = new ImageIcon("Blackarrow.png");
   ImageIcon redArrow = new ImageIcon("Redarrow.png");
   private JLabel blackLabel = new JLabel(blackArrow);
   JLabel redLabel = new JLabel(redArrow);
   private Timer timArrow = new Timer(1500, new ActionListener()
   {
      @Override
      public void actionPerformed(ActionEvent e)
      {
         blackLabel.setVisible(!blackLabel.isVisible());
      }
   });
   ...
   public GUI()
   {
      ...
      attributionMenu.add(imageMenu);
      attributionMenu.add(soundMenu);
      ...
      gbc.gridx = 0;
      gbc.gridy = 0;
      panel3.add(blackLabel, gbc);
      gbc.gridx = 1;
      gbc.gridy = 0;
      panel3.add(redLabel, gbc);
      gbc.gridx = 0;
      gbc.gridy = 1;
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      {
         JOptionPane.showMessageDialog(null, "Image Attribution: From Pixaby\n"
          + "Washer & Dryer - https://pixabay.com/photos/washing-machine-dryer-laundry-902359/\n"
          + "Surfboard - https://pixabay.com/photos/white-male-3d-model-isolated-3d-1834129/\n"
          + "Ninja Airfryer – https://pixabay.com/photos/potatoes-food-dish-meal-air-fryer-8594892/\n"
          + "Nintendo Switch – https://pixabay.com/photos/nintendo-switch-nintendo-console-5392238/\n"
          + "Bluetooth speaker - https://pixabay.com/photos/speaker-bluetooth-bose-phone-5476085/\n"
          + "Red and black arrows - created by myself through screenshots of arrow in word, edited\n"
          + "to make png with transparent background.\n");
      }
      else if(e.getSource() == soundMenu)
      {
         JOptionPane.showMessageDialog(null, "Sound Attribution:\n"
          + "Some intro sound by hotpin7 -- https://freesound.org/s/827124/ -- License: Attribution 4.0.\n");
      }
   }
